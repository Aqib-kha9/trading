...
import { Search, Plus, Radio, Download, List, History, Settings, TrendingUp, ChevronLeft, ChevronRight } from 'lucide-react';
            ...
            <div className="flex-1 min-h-0 relative flex flex-col">
                    ...
                    <div className="flex flex-col h-full gap-2">
                        ...
                        <div className="flex-1 min-h-0 relative flex flex-col">
                            <div className="flex-1 min-h-0 relative">
                                <SignalTable signals={signals} onAction={handleAction} isLoading={isLoading} />
                ...
                {activeTab === 'history' && (
                    <div className="flex flex-col h-full gap-2">
                        ...
                        <div className="flex-1 min-h-0 relative flex flex-col">
                            <div className="flex-1 min-h-0 relative">
                                <SignalTable signals={history} onAction={handleAction} isLoading={isLoading} />
