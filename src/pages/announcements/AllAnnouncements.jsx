...
import { Search, Plus, Megaphone, Download, Radio, Calendar, History, Trash2, Edit, ChevronLeft, ChevronRight, Activity } from 'lucide-react';
                    ...
                    <div className="flex items-center gap-2 text-xs">
                        ...
                        <div className="w-40">
                            <SearchableSelect
                                ...
                                searchable={false}
                                buttonClassName="py-1.5 text-[10px] rounded bg-secondary/30 border-white/10"
                ...
                <div className="flex items-center gap-4">
                    <span>
                        {filteredData.length > 0 ? (
                            <>Showing <span className="text-foreground font-bold">{indexOfFirstItem + 1}-{Math.min(indexOfLastItem, filteredData.length)}</span> of <span className="text-foreground font-bold">{filteredData.length}</span></>
                        ) : (
                            <span className="text-muted-foreground">No events found</span>
                        )}
                        <span className="text-muted-foreground/50 mx-2">|</span>
                        Total: <span className="text-foreground font-bold">{announcements.length}</span>
                    </span>
