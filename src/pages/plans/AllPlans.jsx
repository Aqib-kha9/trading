...
import { Search, Plus, CreditCard, Clock, List, ChevronLeft, ChevronRight } from 'lucide-react';
                ...
                {activeTab === 'plans' && (
                    <div className="flex flex-col h-full gap-2">
                        ...
                        <div className="flex-1 min-h-0 relative">
                            <PlanTable plans={currentPlans} onAction={handleAction} isLoading={isLoading} />
