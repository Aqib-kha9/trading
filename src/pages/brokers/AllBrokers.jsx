...
import { Search, Filter, Plus, ShieldAlert, ChevronLeft, ChevronRight, Briefcase } from 'lucide-react';
    ...
    return (
        <div className="h-full flex flex-col gap-2">
            ...
            <div className="flex-1 min-h-0 relative z-0 flex flex-col">
                <BrokerTable brokers={currentBrokers} onAction={handleAction} isLoading={isLoading} />
