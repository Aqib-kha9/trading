...
import { Search, Plus, MessageSquare, Download, Filter, Inbox, CheckCircle, AlertCircle, Trash2, ChevronLeft, ChevronRight } from 'lucide-react';
    ...
    return (
        <div className="h-full flex flex-col gap-2">
            ...
            <div className="flex-1 min-h-0 relative flex flex-col z-0">
                <TicketTable tickets={currentTickets} isLoading={isLoading} />
