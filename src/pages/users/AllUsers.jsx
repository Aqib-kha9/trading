...
import { Search, Filter, Plus, ShieldAlert, Users, Activity, ChevronLeft, ChevronRight } from 'lucide-react';
    ...
    return (
        <div className="h-full flex flex-col gap-2">
            ...
            <div className="flex-1 min-h-0 relative z-0 flex flex-col">
                <UserTable users={currentUsers} onAction={handleAction} isLoading={isLoading} />
