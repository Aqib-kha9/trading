        ...
        <div className="space-y-6 max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {strategies.map((strategy) => (
                    <Card key={strategy._id || strategy.id} className="p-5 border border-border bg-card hover:border-primary/50 transition-colors group relative overflow-hidden">
                        ...
                        <div className="mt-5 flex gap-2">
                            ...
                            >
                                {strategy.status === 'Active' ? <><Pause size={14} /> Pause Strategy</> : <><Play size={14} /> Start Engine</>}
                            </Button>
