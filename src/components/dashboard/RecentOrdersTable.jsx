            ...
            <div className="flex-1 overflow-auto">
                <table className="w-full text-left border-collapse">
                    <thead className="bg-white/[0.02] text-[10px] uppercase tracking-wider text-muted-foreground font-mono sticky top-0 z-10">
                        <tr>
                            <th className="px-4 py-2 font-medium border-b border-white/5">Order ID</th>
                            <th className="px-4 py-2 font-medium border-b border-white/5">User</th>
                            <th className="px-4 py-2 font-medium border-b border-white/5">Plan</th>
                            <th className="px-4 py-2 font-medium border-b border-white/5">Amount</th>
                            <th className="px-4 py-2 font-medium border-b border-white/5">Status</th>
                            <th className="px-4 py-2 font-medium border-b border-white/5 text-right">Date</th>
                        </tr>
                    </thead>
                    <tbody className="divide-y divide-white/5">
                        {orders.length > 0 ? orders.map((order) => (
                            <tr key={order.id} className="hover:bg-white/[0.02] transition-colors group">
                                ...
                                <td className="px-4 py-2.5 text-[11px] font-mono font-medium text-white/80">{order.amount}</td>
