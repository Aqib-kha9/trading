            ...
            <>
                <Icon
                    ...
                    className={clsx(
                        ...
                        isActive ? "text-primary drop-shadow-[0_0_5px_rgba(16,185,129,0.5)]" : "group-hover:text-white"
                    )}
                />
    ...
    return (
        <div className="w-full">
            <button
                ...
                className={twMerge(
                    "flex items-center gap-3 px-4 py-2.5 w-full text-left border-b border-white/5 transition-all duration-300 group relative hover:bg-white/5",
                    isGroupOpen ? "text-white bg-white/5" : "text-muted-foreground"
                )}
            >
            ...
            >
                ...
                <div className={clsx("h-8 flex items-center border-b border-border px-4 shrink-0 relative z-10", collapsed ? "justify-center px-0" : "justify-between")}>
                    <div className="flex items-center gap-2 overflow-hidden">
                        <div className="w-5 h-5 rounded-md bg-gradient-to-br from-primary to-emerald-600 flex items-center justify-center shadow-lg shadow-primary/20 shrink-0">
                    ...
                    {(!collapsed) ? (
                        <div className="px-4 py-3 space-y-3">
                            {/* <div className="flex items-center justify-between">
                                <span className="text-[9px] font-bold text-muted-foreground uppercase tracking-wider">System Health</span>
                                <div className="flex items-center gap-1.5 bg-emerald-500/10 px-1.5 py-0.5 rounded text-[9px] text-emerald-500 border border-emerald-500/20">
                            ...
                            <div className="space-y-2">
                                ...
                                {/* <div className="flex items-center justify-between text-[10px]">
                                    ...
                                    <span className="text-emerald-400 font-mono text-[9px]">24ms</span>
                                </div> */}
